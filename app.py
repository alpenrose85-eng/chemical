...
class ChemicalAnalyzer:
    ...
    def load_standards(self):
       """Загрузка стандартов из предустановленных файлов"""
        self.standards = {
            "12Х1МФ": {
                "C": (0.10, 0.15),      # исправлено: было (0.08, 0.15)
                "Si": (0.17, 0.37),
                "Mn": (0.40, 0.70),
                "Cr": (0.90, 1.20),
                "Mo": (0.25, 0.35),
                "V": (0.15, 0.30),
                "Ni": (None, 0.25),     # исправлено: было (None, 0.30)
                "Cu": (None, 0.20),     # исправлено: было (None, 0.30)
                "S": (None, 0.025),
                "P": (None, 0.025),     # исправлено: было (None, 0.030)
